...
public class DemoActivityEasyCache extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_demo_activity_easy_cache);
        ...
        mButtonDisplayObjectB.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                long time = end - start;
                if (result != null) {
                    Toast.makeText(DemoActivityEasyCache.this, result, Toast.LENGTH_SHORT).show();
                }
